# element-ingredients_test.sh -- tests the description element rules
#
...
testThatAnIngredientsElementCannotBeEmpty()
{
  xmldoc="$xmldocHeader
  <recipe>
    <name>My Recipe</name>
...
testThatAnIngredientsElementCanHaveAnIngredientChild()
{
  xmldoc="$xmldocHeader
  <recipe>
    <name>My Recipe</name>
...
testThatAnIngredientsElementCanHaveMultipleIngredientChildren()
{
  xmldoc="$xmldocHeader
  <recipe>
    <name>My Recipe</name>
